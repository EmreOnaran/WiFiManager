...
const char *const HTTP_PORTAL_MENU[] PROGMEM = {
    "<form action='/wifi'    method='get'><button>WiFi Seç</button></form><br/>\n",                     // MENU_WIFI
    "<form action='/0wifi'   method='get'><button>WiFi Seç (No Scan)</button></form><br/>\n",           // MENU_WIFINOSCAN
    "<form action='/param'   method='get'><button>Kayıtlı Ağlar</button></form><br/>\n",                // MENU_PARAM
    ...
    "<form action='/erase'   method='get'><button class='D'>Kayıtlı Ağları Sil</button></form><br/>\n", // MENU_ERASE
...
const char HTTP_FORM_WIFI[] PROGMEM = "<label for='s'>WiFi Adı</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Şifre</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' onclick='f()'> Şifreyi Göster";
...
const char HTTP_SCAN_LINK[] PROGMEM = "<br/><form action='/wifi?refresh=1' method='POST'><button name='refresh' value='1'>Sayfayı Yenile</button></form>";
const char HTTP_SAVED[] PROGMEM = "<div class='msg'>Bilgiler Kaydediliyor<br/>UbiHouse internete bağlanıyor.<br />Eğer bağlantıda hata oluşursa yeninden deneyin</div>";
const char HTTP_PARAMSAVED[] PROGMEM = "<div class='msg S'>Kaydet<br/></div>";
...
const char HTTP_STATUS_ON[] PROGMEM = "<div class='msg S'><strong>Bağlandı: </strong>{v}<br/><em><small>with IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[] PROGMEM = "<div class='msg {c}'><strong>İnternet Bağlantısı Yok</strong> to {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[] PROGMEM = "<br/>Ağ Şifresi Hatalı";                                                      // STATION_WRONG_PASSWORD,  no eps32
const char HTTP_STATUS_OFFNOAP[] PROGMEM = "<br/>Kayıtlı Ağ Bulunamadı";                                                // WL_NO_SSID_AVAIL
const char HTTP_STATUS_OFFFAIL[] PROGMEM = "<br/>Bağlantı Yapılamadı";                                                  // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[] PROGMEM = "<div class='msg'>Kayıtlı Bir Ağ Yok</div>";
...
const char HTTP_INFO_aboutver[] PROGMEM = "<dt>WiFi Kurulumu</dt><dd>{1}</dd>";
...
const char S_brand[] PROGMEM = "WiFi Kurulumu";
